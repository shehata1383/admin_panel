...
class CustomTextFieldState extends State<CustomTextField> {
  ...
  String? errorMessage(String str) {
    if (widget.hintText == "serialNumberHint".tr) {
      ...
      return "passwordRequired".tr;
    } else if (widget.hintText == "FullName".tr) {
      return "nameRequired".tr;
    } else if (widget.hintText == "phoneNumber".tr ||
                ...
                child: TextFormField(
                  validator: (value) {
                    ...
                    if ((widget.titleText == "password".tr ||
                      ...
                      String pattern =
                          r'^(?=.*[A-Za-z\u0600-\u06FF])(?=.*[\d\u0660-\u0669])(?=.*[@$!%*?&])[A-Za-z\u0600-\u06FF\d\u0660-\u0669@$!%*?&]{8,}$';
                  ...
                  // لتفادي أي مشاكل مع كيبورد البحث، نترك لوحة المفاتيح نصية مرنة
                  keyboardType: widget.inputType,
                  cursorColor: Theme.of(context).primaryColor,
                  
                  // إيقاف الـ Capitalization تماماً لأنه السبب الرئيسي في تعليق الإدخال العربي بنظام الأندرويد
                  ...
                  // 🔥 التعديل الجوهري للبحث:
                  // عندما لا يكون الحقل أرقاماً أو هاتفاً، نقوم بتمرير فلتر يسمح بجميع الحروف (العربية، الإنجليزية، المسافات، والرموز)
                  // هذا الإجراء يجبر الـ Engine على استقبال الحروف العربية بدلاً من عمل بلوك لها.
                  inputFormatters: widget.isPhone
                      ? <TextInputFormatter>[
                          FilteringTextInputFormatter.allow(RegExp(r'[0-9\u0660-\u0669\+]')),
                        ]
                      : (widget.isAmount || widget.isNumber)
                          ? <TextInputFormatter>[
                              FilteringTextInputFormatter.allow(RegExp(r'[0-9\u0660-\u0669\.]')),
                            ]
                          : <TextInputFormatter>[
                              // يسمح بالحروف العربية والإنجليزية والأرقام والمسافات وعلامات السيرش الشائعة
                              FilteringTextInputFormatter.allow(RegExp(r'[A-Za-z0-9\u0600-\u06FF\s\-\_\.\,\?\!\@\#\$\%\^\&\*\(\)]')),
                            ],
